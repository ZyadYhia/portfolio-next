  ...
  return (
    <div className="max-w-3xl space-y-14">
      <div>
        ...
        <div className="mt-6 space-y-4">
          {education.map((item) => (
            <form
              ...
              className="grid gap-4 rounded-lg border border-(--color-border) bg-(--color-surface) p-5 sm:grid-cols-2"
            >
        ...
        <form
          action={upsertEducation}
          className="mt-4 grid gap-4 rounded-lg border border-dashed border-(--color-border) p-5 sm:grid-cols-2"
        >
          <div className="space-y-1.5 sm:col-span-2">
            <label className={labelClass}>Degree</label>
          ...
          <button
            type="submit"
            className="w-fit rounded-md bg-(--color-teal) px-4 py-2 text-sm font-semibold text-black transition hover:opacity-90 sm:col-span-2"
          >
            Add education
          </button>
        </form>
